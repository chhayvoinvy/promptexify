...
export function CtaSection() {
  return (
    <section className="flex justify-center py-12 relative bg-background">
      {/* Grid Background */}
      ...
      <div className="w-full max-w-5xl rounded-3xl px-8 py-5 md:py-20 lg:py-20 xl:py-20 flex flex-col items-center text-center relative z-10">
        <h2 className="text-4xl md:text-6xl font-bold bg-gradient-to-b from-zinc-600 to-zinc-400 bg-clip-text text-transparent mb-6 dark:from-zinc-400 dark:to-zinc-200">
          Get Started Now!
        </h2>
        <p className="text-lg md:text-2xl text-zinc-500 dark:text-zinc-300 mb-10 max-w-2xl">
